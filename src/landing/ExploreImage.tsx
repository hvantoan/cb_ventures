  ...
  return (
    <div>
        <Card bordered={false} className='absolute bg-pink-transparent px-[10px] left-75'>
            <h1 className='text-primary text-4xl sm:text-2xl'>10 Years</h1>
            <p className='text-2xl sm:text-md text-pink mt-[5px]'>Trading Experience</p>
        </Card>
        ...
        <Card bordered={false} className='absolute bg-pink-transparent px-[10px] right-1/4 sm:right-[20px] bottom-0'>
            ...
            <p className='text-2xl sm:text-md text-pink mt-[5px]'>Safistied Customer</p>
        </Card>
    </div>
  )})
