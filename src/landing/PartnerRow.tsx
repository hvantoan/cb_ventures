...
const PartnerRow = React.memo((column: any) => {
  return (
    <div>
      <Row className="py-[40px] space-x-20 font-bold place-content-center">
        <a className="text-secondary-hbr text-4xl pl-[0px] text-bold content-center pb-[4px]">coinbase</a>
        <a href="">
          <Row>
            <img
              width="48"
        ...
        <a className="text-pink text-4xl pl-[0px] text-bold content-center">
