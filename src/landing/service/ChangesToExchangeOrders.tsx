...
const ChangesToExchangeOrders = React.memo((column: any) => {
  return (
    <div>
      <Card className="place-items-center w-full h-[420px] bg-success-transparent border-primary border-2">
        ...
        <div className="text-center mt-[28px] text-pink text-2xl">Changes To Exchange Orders</div>
...
export default ChangesToExchangeOrders
