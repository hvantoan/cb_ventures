...
const DesignFirstDraft = React.memo((column: any) => {
  return (
    <div>
      <Row className='w-full mt-[90px]'>
        <Card className=" w-[500px] bg-success-transparent p-[10px]">
          <Row className="flex">
            <h1 className="mt-[20px] text-pink text-3xl start-0">Product Research</h1>
            <h1 className="mt-[20px] text-primary text-4xl absolute end-0 mr-[45px]">P1</h1>
          </Row>
...
export default DesignFirstDraft
