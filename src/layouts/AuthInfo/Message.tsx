              ...
              >
                <figure className="inline-flex w-full mb-0 align-top sm:gap-[10px]">
                  ...
                  <figcaption className="min-sm:-mt-1 min-sm:mx-4 ssm:w-full">
                    ...
                    <div>
                      <span className="ltr:pl-0 rtl:pr-0 ltr:mr-4 rtl:ml-4 min-w-[216px]">{message.text}</span>
  ...
  return (
    <div className="flex">
      <PopOver placement="bottomLeft" content={content} action="click">
        ...
        >
          <ReactSVG className="text-[#a0a0a0] dark:text-white/60" src="/img/icon/envelope.svg" />
        </Link>
      </PopOver>
    </div>
  )
