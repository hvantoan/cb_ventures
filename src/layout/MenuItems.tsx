...
function MenuItems() {
  ...
  const items = [
    ...
    getItem(t('eCommerce'), 'ecommerce', !topMenu && <UilShoppingCart />, [
      ...
      getItem(<Link href={`${path}/ecommerce/products/1`}>{t('product details')}</Link>, 'productDetails', null, null),
      getItem(<Link href={`${path}/ecommerce/add-product`}>{t('product add')}</Link>, 'add-product', null, null),
      getItem(<Link href={`${path}/ecommerce/edit-product`}>{t('product edit')}</Link>, 'edit-product', null, null),
    ...
    getItem(`${t('social app')}`, 'profile', !topMenu && <Uil500px />, [
      getItem(<Link href={`${path}/profile/myProfile/overview`}>{t('my profile')}</Link>, 'myProfile', null, null),
    ...
    getItem(t('project'), 'project', !topMenu && <UilBagAlt />, [
      getItem(<Link href={`${path}/project/grid`}>{t('project grid')}</Link>, 'projectGrid', null, null),
      getItem(<Link href={`${path}/project/list`}>{t('project list')}</Link>, 'projectList', null, null),
      getItem(
      ...
      getItem(<Link href={`${path}/project/1/tasklist`}>{t('project details')}</Link>, 'projectDetails', null, null),
    ]),
