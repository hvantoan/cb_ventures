...
const SalesByLocation = React.memo(function SalesByLocation() {
  const rtl = useAppSelector((state) => state.layout.rtlData);
  ...
  const handleChangeLocation = (value: any, event: any) => {
          ...
          <Col xxl={12} md={11} xs={24} className="px-[25px]">
            <div className="min-ssm:h-full h-[250px] overflow-hidden">
              ...
              <ComposableMap
                ...
                projectionConfig={{
                  scale: typeof window !== 'undefined' && window.innerWidth <= 440 ? 160 : 160,
                }}
