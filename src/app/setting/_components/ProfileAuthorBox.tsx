...
import { accountPath, profilePath } from '@/routes';
        ...
        <div className="-mx-3 px-5 pt-[25px] pb-5 text-center border-b border-regular dark:border-white/10">
          <figure className="relative max-w-[120px] mx-auto mb-6">
            <Image
              ...
              src={user?.image ?? '/img/users/1.png'}
              alt=""
              width="120"
              height="120"
            />
          ...
          <figcaption>
            ...
            <p className="mb-0 text-light dark:text-white/60 text-15">Developer</p>
          </figcaption>
        </div>
            ...
            <li>
              <Link
                ...
                className={`flex items-center mb-3 px-5 py-3 rounded-[6px] ${
                  pathname === profilePath || pathname === '' || pathname === undefined
