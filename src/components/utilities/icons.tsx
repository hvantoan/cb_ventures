...
function SwRocket({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwShieldCheck({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwPenTool({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwNotification({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwUsers({ size, color, stroke, strokeWidth }:any) {
  return (
    <svg
      id="Group_1013"
...
function SwLayers({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwPicture({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwClock({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwSend({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwGraph({ size, color, stroke, strokeWidth }:any) {
  return (
...
function SwEllipse({ size, color, stroke, strokeWidth }:any) {
  return (
