...
import { Cards } from '../Cards/Frame/CardsFrame'
    ...
    <div className="mb-[72px]">
      <div className="relative bg-white dark:bg-white/10 min-h-[270px] pt-10 px-[30px] sm:px-[15px] pb-[70px] rounded-[10px]">
        <div className="flex items-center gap-4 sm:flex-col mb-0">
          <Image src="/img/banner/6.png" alt="" width="145" height="160" />
  ...
  return (
    <div className="mb-8">
      <div className="px-5 py-8 text-center bg-white dark:bg-white/10 rounded-10">
        ...
        <Image className="mx-auto" src="/img/banner/9.png" alt="" width="175" height="340" />
      </div>
    </div>
  )
}
...
function PageHeaderBanner({ type, title, subtitle }: any) {
  return (
    <div
      ...
      <div>
        <Row gutter={25} className="items-center">
          ...
          <Col xs={24} sm={24} md={24} lg={24} xl={14} className="flex justify-center">
            {type === 'corporate' ? (
              <Image src="/img/corporate.png" alt="HexaDash Admin Template" width="195" height="175" />
            ) : (
              <Image src="/img/banner/header-banner.png" alt="HexaDash Admin Template" width="195" height="175" />
            )}
          </Col>
        </Row>
      </div>
