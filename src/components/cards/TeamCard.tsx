...
import { UilEllipsisH, UilEye, UilEdit, UilTrashAlt } from '@iconscout/react-unicons'
import socialMediaLinks from '@/data/socialMediaLinks.json'
import DropDown from '@/components/Dropdown'

function TeamCard({ user }: any) {
  const moreContent = [
    {
      key: '1',
      label: (
          ...
          <figcaption>
            <div className="absolute py-1 dark:bg-transparent ltr:right-[24px] rtl:left-[24px] top-[20px] leading-[0.5] rounded-10 text-light-extra dark:text-white/60">
              <DropDown customContent={moreContent}>
                <Link className="text-light-extra dark:text-white/60" href="#" onClick={(e: any) => e.preventDefault()}>
