              ...
              <div className="flex items-start">
                ...
                <div className="flex items-center justify-between flex-1">
                  <div>
                    ...
                    >
                      <span className="text-primary me-1.5 font-medium capitalize">Ibrahim Riaz</span> send you a
                      message
                    </Heading>
                ...
                <div className="flex items-center justify-between flex-1">
                  <div>
                    <Heading
                      ...
                      className="flex items-center justify-between mb-0.5 text-[#5a5f7d] dark:text-white/[.87] text-sm font-normal flex-wrap"
                    >
                      <span className="text-primary ltr:mr-1.5 rtl:ml-1.5 font-medium capitalize">shamim ahmed</span>{' '}
                      sent you a message
                    </Heading>
                ...
                <div className="flex items-center justify-between flex-1">
                  <div>
                    <Heading
                      ...
                      className="flex items-center justify-between mb-0.5 text-[#5a5f7d] dark:text-white/[.87] text-sm font-normal flex-wrap"
                    >
                      <span className="text-primary ltr:mr-1.5 rtl:ml-1.5 font-medium capitalize">tanjim ahmed</span>{' '}
                      sent you a message
                    </Heading>
                ...
                <div className="flex items-center justify-between flex-1">
                  <div>
                    <Heading
                      ...
                      className="flex items-center justify-between mb-0.5 text-[#5a5f7d] dark:text-white/[.87] text-sm font-normal flex-wrap"
                    >
                      <span className="text-primary ltr:mr-1.5 rtl:ml-1.5 font-medium capitalize">masud rana</span> sent
                      you a message
                    </Heading>
  ...
  return (
    <div className="flex">
      <PopOver placement="bottomLeft" content={content} action="click">
        ...
        >
          <ReactSVG className="text-[#a0a0a0] dark:text-white/60" src="/img/icon/bell.svg" />
        </Link>
      </PopOver>
    </div>
  )
