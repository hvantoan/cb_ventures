  ...
  return (
    <div>
      <Row>
        ...
        <Card
          bordered={false}
          className="bg-regularBGdark w-[370px] p-0 shadow-gray-50 h-[80px] sm:w-full sm:text-center"
        >
          <h5 className="absolute text-pink w-full p-[20px] top-0 left-0 h-full">
            Lending Money For Investment Of Your New Projects
          </h5>
        </Card>
        <Card
          bordered={true}
          className="bg-inherit w-[370px] p-0 mt-5 border-slate-500 h-[80px] sm:w-full sm:text-center"
        >
          <h5 className="absolute text-deep w-full p-[20px] top-0 left-0 h-full">
            Lending Money For Investment Of Your New Projects
          </h5>
        </Card>
        <Card
