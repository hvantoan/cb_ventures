...
const Cryptocurrency = React.memo((column: any) => {
  return (
    <div>
        ...
        <div className="flex justify-center justify-items-center mt-[30px]">
          <Card className="rounded-full w-[125px] h-[125px]">
            <img
              width="96"
              height="96"
              src="https://img.icons8.com/pulsar-gradient/96/mobile-mining.png"
              alt="mobile-mining"
            />
          </Card>
        </div>
        <div className="text-center mt-[28px] text-pink text-2xl">Cryptocurrency Platform</div>
