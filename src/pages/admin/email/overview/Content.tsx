...
import { UilAngleLeft, UilAngleRight, UilPaperclip, UilSlidersV, UilEllipsisV } from '@iconscout/react-unicons'
...
function Content({ searchData, email }: any) {
  ...
  useEffect(() => {
    setState((prevState) => ({
      ...prevState, // Include existing state properties
      emails: email,
      selectedRowKeys,
      sort,
    }))
    ...
    selections: [
      {
        key: 'all',
        text: (
          <div className="flex items-center text-theme-gray dark:text-white/60 hover:bg-primary-transparent hover:text-primary dark:hover:bg-white/10 px-3 py-1.5 text-sm active">
            <span>All</span>
          </div>
        ),
        onSelect: () => {
      ...
      },
      {
        key: 'read',
        text: (
          <div className="flex items-center text-theme-gray dark:text-white/60 hover:bg-primary-transparent hover:text-primary dark:hover:bg-white/10 px-3 py-1.5 text-sm capitalize">
            <span>read</span>
          </div>
        ),
  ...
  const columns = [
    ...
    {
      title: (
        <div className="flex items-center justify-end [&>div]:max-w-[350px] [&>div>div>span>span:first-child]:h-[44px] [&>div>div>span>span:first-child>input]:h-[44px] [&>div>div>span>span:first-child>input]:bg-transparent [&>div>div>span>span:first-child]:rounded-[23px] [&>div>div>span>span:first-child]:border-none [&>div>div>span>span:first-child]:bg-normalBG dark:[&>div>div>span>span:first-child]:bg-white/10 [&>div>div>span>span:last-child>span>span>svg]:text-dark dark:[&>div>div>span>span:last-child>span>span>svg]:text-white/[.87] [&>div>.ant-select-selector]:bg-transparent [&>div>.ant-select-selector>.ant-select-selection-placeholder]:h-11 [&>div>.ant-select-selector>.ant-select-selection-placeholder]:leading-[42px] [&>div>.ant-select-selector>.ant-select-selection-placeholder]:px-5">
