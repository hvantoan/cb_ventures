...
function Single() {
    ...
    return (
      <>
        <div className="flex gap-5 ssm:flex-col">
          <img className="w-[50px] h-[50px] rounded-full object-cover" src="/img/email/2.png" alt="" />
  ...
  function ForwardMessage() {
    return (
      <>
        <div className="flex gap-5 ssm:flex-col">
          <img className="w-[50px] h-[50px] rounded-full object-cover" src="/img/email/1.png" alt="" />
          <MailComposer replay defaultTag="Vincent Porter" onSend={replyMail} />
        </div>
      </>
    )
  }
