...
function ProjectList() {
  ...
  if (projects.length)
    projects.map((value: any) => {
      ...
      return dataSource.push({
        ...
        assigned: (
          <>
            <ul className="flex items-center -m-[3px] p-0 gap-[3px]">
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/1.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/2.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/3.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/4.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/5.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/6.png" alt="" />
              </li>
              <li>
                <img className="w-[35px] min-w-[35px] h-[35px] rounded-full" src="/img/users/7.png" alt="" />
              </li>
            </ul>
          </>
        ),
        ...
        action: (
          <DropDown className="min-w-[140px]" customContent={moreContent}>
            <Link href="#">
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'action',
      className:
        'text-light dark:text-white/60 text-[15px] last:text-end last:[&>span>a]:flex last:[&>span>a]:justify-end border-regular before:hidden',
    },
  ]
