...
function CreateProject({ visible, onCancel }: any) {
    ...
    >
      <div className="px-1.5">
        <Form form={form} name="createProject" onFinish={handleOk}>
          ...
          <Form.Item name="category" initialValue="" label="" className="[&>.ant-form-item-row>div]:flex-auto">
            <Select
          ...
          >
            <Input.TextArea
              ...
              className="p-3 hover:border-primary dark:placeholder-white/60"
            />
          </Form.Item>
          <Form.Item
            name="privacy"
          ...
          >
            <CheckboxGroup
              options={options}
              className="[&>.ant-checkbox-wrapper>.ant-checkbox>.ant-checkbox-inner]:hover:border-primary [&>.ant-checkbox-wrapper-checked>.ant-checkbox>.ant-checkbox-inner]:bg-primary [&>.ant-checkbox-wrapper-checked>.ant-checkbox>.ant-checkbox-inner]:border-primary"
            />
          </Form.Item>
          <Form.Item
            name="members"
