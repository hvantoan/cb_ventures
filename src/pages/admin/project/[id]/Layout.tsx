            ...
            <div className="bg-white dark:bg-white/10 min-h-[485px] mb-[25px] rounded-[10px]">
              ...
              <div className="flex flex-col gap-y-[25px] p-[25px]">
                <div className="flex items-center gap-x-[15px]">
                  <div>
                    <img className="w-[45px] h-[45px] rounded-full" src="/img/users/1.png" alt="" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-x-[15px]">
                  <div>
                    <img className="w-[45px] h-[45px] rounded-full" src="/img/users/3.png" alt="" />
                  </div>
                  <div>
                    <Heading as="h5" className="text-dark dark:text-white/[.87] text-sm font-semibold mb-0.5">
                      Tuhin Molla
                ...
                <div className="flex items-center gap-x-[15px]">
                  <div>
                    <img className="w-[45px] h-[45px] rounded-full" src="/img/users/9.jpg" alt="" />
                  </div>
                  <div>
                    <Heading as="h5" className="text-dark dark:text-white/[.87] text-sm font-semibold mb-0.5">
                      Billal Hossain
                ...
                <div className="flex items-center gap-x-[15px]">
                  <div>
                    <img className="w-[45px] h-[45px] rounded-full" src="/img/users/4.png" alt="" />
                  </div>
                  <div>
                    <Heading as="h5" className="text-dark dark:text-white/[.87] text-sm font-semibold mb-0.5">
                      Khalid Hasan
                ...
                <div className="flex items-center gap-x-[15px]">
                  <div>
                    <img className="w-[45px] h-[45px] rounded-full" src="/img/users/5.png" alt="" />
                  </div>
                  <div>
                    <Heading as="h5" className="text-dark dark:text-white/[.87] text-sm font-semibold mb-0.5">
                      Meyri Carles
