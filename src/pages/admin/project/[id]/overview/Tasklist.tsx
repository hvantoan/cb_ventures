...
import { UilEye, UilEdit, UilPlus, UilTrashAlt, UilEllipsisH, UilExpandArrows } from '@iconscout/react-unicons'
...
function ProjectTaskList() {
  ...
  const dataSource = [
    {
      key: '1',
      title: <span className="text-body dark:text-white/60 text-[15px]">Add Images To the gallery</span>,
      component: (
        <div className="flex items-center justify-end -mx-[10px]">
          <span className="block mx-[10px] text-xs text-[#9299b8] dark:text-white/60 leading-none">09:20 AM </span>
          <img className="block mx-[10px] leading-none" style={{ width: '30px' }} src="/img/users/1.png" alt="" />
    ...
    {
      key: '2',
      title: <span className="text-body dark:text-white/60">Add Images To the gallery</span>,
      component: (
        <div className="flex items-center justify-end -mx-[10px]">
          <span className="block mx-[10px] text-xs text-[#9299b8] dark:text-white/60 leading-none">09:20 AM </span>
          <img className="block mx-[10px] leading-none" style={{ width: '30px' }} src="/img/users/1.png" alt="" />
