                  ...
                  items={[
                    {
                      ...
                      children: (
                        <div className="ms-[15px]">
                          <h3 className="text-dark dark:text-white/[.87] mb-[30px] text-sm font-medium">02:30 PM</h3>
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="ms-[15px]">
                          <h3 className="text-dark dark:text-white/[.87] mb-[30px] text-sm font-medium">12:30 PM</h3>
                          <p className="max-w-[360px] text-body dark:text-white/60">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                          </p>
                          <span className="tags">HTML,CSS,VueJS</span>
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="ms-[15px]">
                          <h3 className="text-dark dark:text-white/[.87] mb-[30px] text-sm font-medium">01:00 PM</h3>
                          <p className="max-w-[360px] text-body dark:text-white/60">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                          </p>
                          <span className="tags">HTML,CSS,VueJS</span>
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="ms-[15px]">
                          <h3 className="text-dark dark:text-white/[.87] mb-[30px] text-sm font-medium">01:30 PM</h3>
                          <p className="max-w-[360px] text-body dark:text-white/60">
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                          </p>
                          <span className="tags">HTML,CSS,VueJS</span>
                  ...
                  items={[
                    {
                      ...
                      children: (
                        <div className="relative after:absolute after:content-[''] after:w-0 after:h-0 after:-translate-y-2/4 after:border-r-[16px] after:border-r-[rgb(227,230,239)] after:border-y-8 after:border-y-transparent after:border-solid after:-left-4 after:top-[40%]">
                          <h4 className="mb-2 text-sm text-light-extra">06:00 AM</h4>
                          <div className="bg-normalBG dark:bg-whiteDark px-5 py-[18px] rounded-[10px]">
                            <p className="text-[#666d92] dark:text-white/60 text-start text-[15px] leading-[26px]">
                              Lorem Ipsum is simply dummy text of theprintng and typesetting industry. Lorem Ipsum has
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="me-[7px] relative after:absolute after:content-[''] after:w-0 after:h-0 after:-translate-y-2/4 after:border-l-[16px] after:border-l-[rgb(227,230,239)] after:border-y-8 after:border-y-transparent after:border-solid after:-right-4 after:top-[40%]">
                          <h4 className="mb-2 text-sm text-light-extra">10:00 AM</h4>
                          <div className="bg-normalBG dark:bg-whiteDark px-5 py-[18px] rounded-[10px]">
                            <p className="text-[#666d92] dark:text-white/60 text-start text-[15px] leading-[26px]">
                              Lorem Ipsum is simply dummy text of theprintng and typesetting industry. Lorem Ipsum has
                              been the industry`s standard dummy text ever since the,
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="relative after:absolute after:content-[''] after:w-0 after:h-0 after:-translate-y-2/4 after:border-r-[16px] after:border-r-[rgb(227,230,239)] after:border-y-8 after:border-y-transparent after:border-solid after:-left-4 after:top-[40%]">
                          <h4 className="mb-2 text-sm text-light-extra">07:00 AM</h4>
                          <div className="bg-normalBG dark:bg-whiteDark px-5 py-[18px] rounded-[10px]">
                            <p className="text-[#666d92] dark:text-white/60 text-start text-[15px] leading-[26px]">
                              Lorem Ipsum is simply dummy text of theprintng and typesetting industry. Lorem Ipsum has
                              been the industry`s standard dummy text ever since the,
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="me-[7px] relative after:absolute after:content-[''] after:w-0 after:h-0 after:-translate-y-2/4 after:border-l-[16px] after:border-l-[rgb(227,230,239)] after:border-y-8 after:border-y-transparent after:border-solid after:-right-4 after:top-[40%]">
                          <h4 className="mb-2 text-sm text-light-extra">02:00 AM</h4>
                          <div className="bg-normalBG dark:bg-whiteDark px-5 py-[18px] rounded-[10px]">
                            <p className="text-[#666d92] dark:text-white/60 text-start text-[15px] leading-[26px]">
                              Lorem Ipsum is simply dummy text of theprintng and typesetting industry. Lorem Ipsum has
                              been the industry`s standard dummy text ever since the,
                    ...
                    },
                    {
                      ...
                      children: (
                        <div className="relative after:absolute after:content-[''] after:w-0 after:h-0 after:-translate-y-2/4 after:border-r-[16px] after:border-r-[rgb(227,230,239)] after:border-y-8 after:border-y-transparent after:border-solid after:-left-4 after:top-[40%]">
                          <h4 className="mb-2 text-sm text-light-extra">11:00 PM</h4>
                          <div className="bg-normalBG dark:bg-whiteDark px-5 py-[18px] rounded-[10px]">
                            <p className="text-[#666d92] dark:text-white/60 text-start text-[15px] leading-[26px]">
                              Lorem Ipsum is simply dummy text of theprintng and typesetting industry. Lorem Ipsum has
                              been the industry`s standard dummy text ever since the,
