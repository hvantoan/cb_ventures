            ...
            <Col md={12} xs={24}>
              <div className="bg-white dark:bg-white/10 m-0 p-0 text-theme-gray dark:text-white/60 text-[15px] mb-[25px] rounded-10 relative">
                ...
                <div className="flex flex-wrap gap-y-[20px] flex-col w-full p-[25px]">
                  ...
                  <DatePicker onChange={onChangeBasic} picker="week" />
                  <DatePicker onChange={onChangeBasic} picker="month" />
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-white/10 m-0 p-0 text-theme-gray dark:text-white/60 text-[15px] mb-[25px] rounded-10 relative">
                ...
                <div className="flex flex-wrap gap-y-[20px] flex-col w-full p-[25px]">
                  ...
                  <DatePicker defaultValue={dayjs('2015-06-06', dateFormatList)} disabled />
            ...
            <Col lg={12} md={24}>
              <div className="bg-white dark:bg-white/10 m-0 p-0 text-theme-gray dark:text-white/60 text-[15px] mb-[25px] rounded-10 relative">
                <div className="h-[60px] px-[25px]">
                  ...
                  <p className="text-theme-gray dark:text-white/60">Custom Date Range</p>
                </div>
            ...
            <Col xxl={16} xs={24}>
              <div className="bg-white dark:bg-white/10 m-0 p-0 text-theme-gray dark:text-white/60 text-[15px] mb-[25px] rounded-10 relative">
                <div className="h-[60px] px-[25px]">
                  ...
                  <p className="text-theme-gray dark:text-white/60">The simplest use of Date picker</p>
                </div>
                <div className="p-[25px]">
                  <DateRangePickerOne />
                </div>
