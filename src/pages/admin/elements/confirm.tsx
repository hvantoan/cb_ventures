              ...
              <div className="demo placement-confirm p-[25px]">
                <div className="pop-confirm pop-confirm-top gap-[10px] flex flex-wrap whitespace-nowrap min-3xl:ltr:ml-[100px] min-3xl:rtl:mr-[100px] 3xl:mb-[15px]">
                  <Popconfirm placement="topLeft" title={text} onConfirm={confirm} okText="Yes" cancelText="No">
                    <Button className="border-solid border-1 border-normal dark:border-white/10 hover:text-primary hover:border-primary text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-4 px-[20px] h-[44px] min-w-[80px] xs:min-w-[70px] dark:bg-white/10">
                      TL
                    </Button>
                  </Popconfirm>
                ...
                <div className="pop-confirm pop-confirm-bottom  gap-[10px] flex flex-wrap whitespace-nowrap min-3xl:ltr:ml-[100px] min-3xl:rtl:mr-[100px] 3xl:mt-[15px]">
                  ...
                  <Popconfirm placement="bottom" title={text} onConfirm={confirm} okText="Yes" cancelText="No">
                    <Button className="border-solid border-1 border-normal dark:border-white/10 hover:text-primary hover:border-primary text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-4 px-[20px] h-[44px] min-w-[80px] xs:min-w-[70px] max-w-[80px] dark:bg-white/10">
                      Bottom
                    </Button>
                  </Popconfirm>
