              ...
              <div>
                <Cards headless size="large" className="mb-[25px] ant-card-body-p-25">
                  ...
                  <Row gutter={15} className="gap-y-[15px]">
                    <Col md={5}>
                      <div className="bg-gradient-to-r from-primary flex items-center justify-between rounded-[10px] py-[35px] px-[20px] text-white dark:text-white/[.87] h-[100px]">
                        <span className="sm:me-10 me-0 fs-15">#8231D3</span>
                      </div>
                    </Col>
                    <Col md={5}>
                    ...
                    <Col md={5}>
                      <div className="bg-gradient-to-r from-primary via-secondary to-primary flex items-center justify-between gap-[15px] rounded-[10px] py-[35px] px-[20px] text-white dark:text-white/[.87] h-[100px] overflow-auto">
                        <span className="sm:me-5 me-0 fs-15">#8231D3</span>
                        <span className="ms-5 fs-15">#5840FF</span>
                        <span className="sm:me-5 me-0 fs-15">#8231D3</span>
                      </div>
