              ...
              <div className="p-[25px]">
                <Result
                  ...
                  extra={[
                    ...
                    <Button key="buy" className="dark:text-white/[.87] dark:hover:text-info">
                      Buy Again
                    </Button>,
                  ]}
                />
              ...
              <div className="p-[25px]">
                <Result
                  ...
                  extra={[
                    ...
                    <Button className="dark:text-white/[.87] dark:hover:text-info" key="buy">
                      Buy Again
                    </Button>,
                  ]}
                >
                  <div className="desc">
                    ...
                    <Paragraph className="flex items-center gap-1">
                      ...
                      <Link href="#">Thaw immediately &gt;</Link>
                    </Paragraph>
                    <Paragraph className="flex items-center gap-1">
                      <CloseCircleOutlined style={{ color: 'red' }} /> Your account is not yet eligible href apply{' '}
                      <Link href="#">Apply Unlock &gt;</Link>
                    </Paragraph>
                  </div>
                </Result>
              </div>
