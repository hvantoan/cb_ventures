...
import { UilPlus, UilMinus, UilEdit, UilCheck, UilTrashAlt } from '@iconscout/react-unicons'
...
function CheckOut() {
  ...
  const { cartData, rtl } = useSelector((state: any) => {
    return {
        ...
        product: (
          <div className="w-[300px]">
            <div className="flex items-center gap-x-[25px]">
              <img className="max-w-20 max-h-20 rounded-[10px]" style={{ width: 80 }} src={`/${img}`} alt="" />
              <figcaption>
                <div>
                  ...
                  <Col sm={22} xs={24}>
                    ...
                    <Radio.Group style={{ width: '100%' }}>
                          ...
                          >
                            <div className="flex items-center justify-between flex-wrap mb-[20px] gap-[10px]">
                              ...
                              <div className="flex items-start gap-[15px]">
                                <img style={{ width: '50px' }} src="/img/cards-logo/ms.png" alt="" />
                                <img style={{ width: '50px' }} src="/img/cards-logo/american-express.png" alt="" />
                                <img style={{ width: '50px' }} src="/img/cards-logo/visa.png" alt="" />
                              </div>
                            </div>
                            <Cards
                      ...
                      <div className="mb-[25px]">
                        ...
                        >
                          Pay With PayPal
                          <img className="xs:hidden" src="/img/PayPalLogo.png" alt="paypal" />
                        </Radio>
                      </div>
                      <div className="">
                        <Radio
