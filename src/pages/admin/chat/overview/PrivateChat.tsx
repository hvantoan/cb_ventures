...
function PrivateChat() {
  const chatData = useSelector((state: any) => state.chat.data)

  const path = ' /admin/chat/private'

  const dispatch = useDispatch()
  const dataFiltering = (email: any) => {
    //@ts-ignore
                ...
                >
                  <div className="flex items-center">
                    <div className="ltr:mr-[15px] rtl:ml-[15px]">
                      <img className="max-w-[46px] min-h-[46px] rounded-full" src={`/img/chat-author/${img}`} alt="" />
