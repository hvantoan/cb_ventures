          ...
          title={
            <div className="flex py-2">
              ...
              <div className="flex items-center justify-center w-full gap-x-1">
                <Link href="#">
                  <img className="max-w-[30px]" src="/img/avatar/chat-auth.png" alt="" />
                </Link>
                <Link href="#">
                  <img className="max-w-[30px]" src="/img/avatar/chat-auth.png" alt="" />
                </Link>
                ...
                <Link href="#" className="flex items-center justify-center bg-primary w-[30px] h-[30px] rounded-full">
            ...
            <div>
              {singleContent.length ? (
                singleContent.map((mes: any, index: number) => {
                  ...
                  return (
                    <li key={id} className="mb-[30px] px-[25px] sm:px-[15px] last:mb-0" style={{ overflow: 'hidden' }}>
                      <div
