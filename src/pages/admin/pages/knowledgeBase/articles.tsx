...
const items: CollapseProps['items'] = [
  {
    key: '1',
    label: (
      <div className="font-normal text-body dark:text-white/60 hover:text-primary text-15">Switch between accounts</div>
    ),
    children: (
      <ul className="bg-transparent ps-[25px]">
        <li className="mb-4">
          <Link href={`${path}/single`} className="font-normal text-body dark:text-white/60 hover:text-primary text-15">
            {' '}
            ...
            <div className="pt-6 pb-10">
              <ul className="flex items-center mb-0">
                <li className="ltr:mr-2 rtl:ml-2">
                  <Link className="text-sm text-dark dark:text-white/[.87]" href="/admin/knowledgebase/plugins">
                    Doc Home
                  </Link>
                </li>
                <li>
              ...
              <div className="pb-16 border-b mb-11 border-normal dark:border-white/10">
                <div className="flex justify-between flex-start lg:flex-col gap-x-[100px] lg:gap-y-3 mb-14">
                  <div className="min-w-[260px] sm:min-w-full">
                    <h2 className="text-dark dark:text-white/[.87] text-[23px] font-medium">Introduction to Plugin</h2>
                  </div>
                ...
                <div className="flex justify-between flex-start lg:flex-col gap-x-[100px] lg:gap-y-3 mb-14">
                  <div className="min-w-[260px] sm:min-w-full">
                    <h2 className="text-dark dark:text-white/[.87] text-[23px] font-medium">Manage your account</h2>
                  </div>
                  <ul className="flex flex-wrap mb-0">
                    <li className="max-w-[250px] flex-[0_0_50%] 3xl:flex-[0_0_40%] md:flex-[0_0_100%] mb-4">
                      <Link
