  ...
  return (
    <div className="flex flex-col">
      <div className="px-[30px] md:px-[15px] sm:px-0">
        ...
        <div className="mb-10">
          <h4 className="mb-4 font-semibold text-22 sm:text-xl ssm:text-lg">
            <Link href="#" className="text-dark dark:text-white/[.87]">
              Configuration
            </Link>
          </h4>
          ...
          <Link href="#" className="btn-more text-link hover:text-primary">
            Read More
          </Link>
        </div>
        <div className="mb-10">
        ...
        <div className="flex items-center justify-center flex-wrap gap-x-10 gap-y-[15px] min-h-[106px] p-[15px] my-[25px] border border-normal dark:border-white/10 shadow-[0_5px_10px_rgba(10,10,10,0.06)] rounded-[5px]">
          <h4 className="mb-0 text-dark dark:text-white/60">Was this article helpful?</h4>
        ...
        <div className="flex items-center justify-between flex-wrap gap-[15px] pb-[42px] mb-[25px] border-b border-normal dark:border-white/10">
          <div className="text-base font-medium">
            <span className="text-body dark:text-white/60">Still need help?</span>
            <Link href="#" className="ml-[14px] text-link hover:text-primary">
              Submit a Request
            </Link>
          </div>
          <ul className="flex items-center mb-0">
            <li className="ltr:mr-[10px] rtl:ml-[10px]">
              <span className="text-sm font-normal text-body dark:text-white/60">Share this article:</span>
            </li>
            <li className="ltr:mr-[10px] rtl:ml-[10px]">
              <Link href="#">
                <FontAwesome
            ...
            <li>
              <Link href="#">
                <span className="mb-1.5 text-light dark:text-white/60 text-[13px]">
                  <FontAwesome className="inline-block text-sm ltr:mr-2 rtl:ml-2" name="angle-left" size="2x" />
                  <span>Previous article</span>
                </span>
                <h5 className="text-sm text-dark dark:text-white/[.87]">Stop getting emails from lorem</h5>
              </Link>
            </li>
            <li>
              <Link href="#">
                ...
                <h5 className="text-sm text-dark dark:text-white/[.87]">Use threads to organize discussions</h5>
              </Link>
            </li>
          </ul>
        </div>
      ...
      <div className="mb-[30px] pt-6 px-[30px] pb-[26px] border border-normal dark:border-white/10">
        <h4 className="mb-[18px] text-dark dark:text-white/[.87] text-xl font-medium">Related articles</h4>
        <ul className="mb-0">
          <li className="mb-[10px]">
            <Link href="#" className="flex">
              ...
              <h5 className="mb-0 text-body dark:text-white/60 text-15">Installing loremm ulti vendor marketplace</h5>
            </Link>
          </li>
          <li className="mb-[10px]">
            <Link href="#" className="flex">
              ...
              <h5 className="mb-0 text-body dark:text-white/60 text-15">Copyright and trademarks</h5>
            </Link>
          </li>
          <li>
            <Link href="#" className="flex">
              ...
              <h5 className="mb-0 text-body dark:text-white/60 text-15">Stop getting emails from lorem</h5>
            </Link>
          </li>
        </ul>
      </div>
      <div className="mb-[30px] pt-6 px-[30px] pb-[26px] border border-normal dark:border-white/10">
        <h4 className="mb-[18px] text-dark dark:text-white/[.87] text-xl font-medium">Leave comment</h4>
        <Form name="comment" layout="vertical">
          <Row gutter={20}>
            <Col sm={12} xs={24}>
              <Form.Item label="Name" name="name" className="dark:[&>div>div>label]:text-white/60">
          ...
          <Row>
            <Col xs={24}>
              <Form.Item label="Comment" name="comment" className="dark:[&>div>div>label]:text-white/60">
                <TextArea rows={4} className="border-normal dark:border-white/10 hover:border-primary" />
              </Form.Item>
            </Col>
          </Row>
          <Row>
