            ...
            <div className="bg-white dark:bg-white/10 pt-[90px] pb-20 px-[15px] sm:py-10 text-center rounded-10">
              <div className="mb-[50px] xl:mb-[30px] md:mb-[25px]">
                {mainContent === 'lightMode' ? (
                  <Image className="mx-auto" src={'/img/logo_dark.svg'} alt="" width="140" height="32" />
                ) : (
                  <Image className="mx-auto" src={'/img/logo_white.svg'} alt="" width="140" height="32" />
                )}
              </div>
              ...
              <p className="text-body dark:text-white/60 mb-0">2023 © Sovware</p>
            </div>
          </Col>
        </Row>
      </main>
