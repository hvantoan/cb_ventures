            ...
            >
              <div className="-mx-4 -mb-4 px-6 pt-5 pb-[30px] border-t dark:border-white/10">
                <p className="font-normal mb-9 text-body dark:text-white/60 text-15">
                  ...
                  as FAQ&rsquo;s and comments from previous buyers. Anim pariatur cliche reprehenderit, enim eiusmod
                  high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard
                  dolor brunch. Food truck quinoa nesciunt laborum eiusmod.Brunch 3 wolf moon tempor, sunt aliqua put a
