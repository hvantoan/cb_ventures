...
import { UilPlus, UilMinus, UilSmile, UilFrown } from '@iconscout/react-unicons'
...
const text = (
  <div className="-mx-4 -mb-4 px-6 pt-3 pb-[30px]">
    <p className="font-normal mb-9 text-body dark:text-white/60 text-15">
      Many support queries and technical questions will already be answered in supporting documentation such as
      FAQ&rsquo;s and comments from previous buyers. Anim pariatur cliche reprehenderit, enim eiusmod high life
      accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck
      quinoa nesciunt laborum eiusmod.Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee
    ...
    <>
      <FaqLayout>
        <div className="bg-white dark:bg-white/10 p-[25px] text-xl rounded-[10px]">
          ...
          <Collapse
            className="bg-transparent border-none [&>.ant-collapse-item]:border-regular dark:[&>.ant-collapse-item]:border-white/10 [&>.ant-collapse-item]:border-1 [&>.ant-collapse-item]:mb-[10px] [&>.ant-collapse-item]:rounded-6 [&>.ant-collapse-item>.ant-collapse-header]:px-[20px] [&>.ant-collapse-item>.ant-collapse-header]:py-[18px]"
            expandIcon={({ isActive }) =>
              isActive ? <UilMinus className="w-4 h-4" /> : <UilPlus className="w-4 h-4" />
            }
            accordion
            items={items}
          />
