...
function Notification() {
  ...
  const handleNotificationSwitchChange = (index: any) => (checked: boolean) => {
  ...
  const handleActivitySwitchChange = (index: any) => (checked: boolean) => {
                ...
                <div className="notification-box-single">
                  <div className="bg-regularBG dark:bg-regularBGdark p-[25px] sm:px-[15px] border dark:border-white/10 rounded-[10px]">
                    <div className="flex items-center justify-between h-[50px]">
                      ...
                      <Link className="text-info text-[13px]" href="#0" onClick={handleNotificationToggleAll}>
                        Toggle all
                      </Link>
                    </div>
                      ...
                      <nav>
                        <ul className="mb-0">
                          <li className="flex items-center justify-between mb-0 px-[25px] py-[20px] border-b border-regular dark:border-white/10 [&>button]:bg-[#c6c6c6] [&>.ant-switch-checked]:bg-primary [&>button]:shadow-none gap-[15px]">
                            ...
                            <Switch
                              checked={notificationSwitchStates[0]}
                              onChange={handleNotificationSwitchChange(0)}
                            />
                          </li>
                          <li className="flex items-center justify-between mb-0 px-[25px] py-[20px] border-b border-regular dark:border-white/10  [&>button]:bg-[#c6c6c6] [&>.ant-switch-checked]:bg-primary [&>button]:shadow-none gap-[15px]">
                            <div>
                            ...
                            <Switch
                              checked={notificationSwitchStates[1]}
                              onChange={handleNotificationSwitchChange(1)}
                            />
                          </li>
                          <li className="flex items-center justify-between mb-0 px-[25px] py-[20px] border-b border-regular dark:border-white/10  [&>button]:bg-[#c6c6c6] [&>.ant-switch-checked]:bg-primary [&>button]:shadow-none gap-[15px]">
                            <div>
                            ...
                            <Switch
                              checked={notificationSwitchStates[3]}
                              onChange={handleNotificationSwitchChange(3)}
                            />
                          </li>
                          <li className="flex items-center justify-between mb-0 px-[25px] py-[20px] border-b border-regular dark:border-white/10  [&>button]:bg-[#c6c6c6] [&>.ant-switch-checked]:bg-primary [&>button]:shadow-none gap-[15px]">
                            <div>
                            ...
                            <Switch
                              checked={notificationSwitchStates[4]}
                              onChange={handleNotificationSwitchChange(4)}
                            />
                          </li>
                        </ul>
                      </nav>
                ...
                <div className="notification-box-single">
                  <div className="bg-regularBG dark:bg-regularBGdark p-[25px] sm:px-[15px] border dark:border-white/10 rounded-[10px]">
                    <div className="flex items-center justify-between h-[50px]">
                      ...
                      <Link className="text-info text-[13px]" href="#0" onClick={handleActivityToggleAll}>
                        Toggle all
                      </Link>
                    </div>
                    <div className="bg-white dark:bg-[#202531] shadow-[0_5px_20px_rgba(173,181,217,0.05)] rounded-[10px] overflow-hidden">
